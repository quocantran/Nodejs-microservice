...
class CheckoutService {
  ...
  static async orderByUser(payload: any) {
  ...
  static async cancelOrdersByUser(userId: string) {}

  static async updateOrderStatus(userId: string) {}

  static async getOneOrderByUser(userId: string) {}
}
